...
$(document).ready(function () {
    $("#sel2").click(function() {
       ...
       $("#sel3").removeClass('bgy').addClass('bgn');
        console.log($("#sese").attr("class"));
        if ($("#sese").attr("class") == "grid3") {
            $("#sese").attr("class","grid2");
        }
        if ($("#sese1").attr("class") == "grid3") {
            $("#sese1").attr("class","grid2");
        }
    });
});
...
$(document).ready(function () {
    $("#sel3").click(function() {
    $(this).removeClass('bgn').addClass('bgy');
    $("#sel2").removeClass('bgy').addClass('bgn');
        console.log($("#sese").attr("class"));
        if ($("#sese").attr("class") == "grid2") {
            $("#sese").attr("class","grid3");
        }
        if ($("#sese1").attr("class") == "grid2") {
            $("#sese1").attr("class","grid3");
        }
    });
});
...
(function($){
	...
	var sticky_navigation_offset_top = $('#upmu').offset().top;
	...
	var sticky_navigation = function(){
		...
		if (scroll_top > sticky_navigation_offset_top) { 
			$('.upmuin').css({ 'position': 'fixed','top':'0' });
		} else {
			$('.upmuin').css({ 'position': 'relative','top':'0' }); 
		}   
	};
...
$(document).ready(function(){
    ...
    var offCover = {
        init : function() {
            $(function() {
               $('#wrap').append('<a href="#container" id="btnFoldLayout"><img src="/something/btn_delete.png" class="closeimg"></a>');
                offCover.resize();
