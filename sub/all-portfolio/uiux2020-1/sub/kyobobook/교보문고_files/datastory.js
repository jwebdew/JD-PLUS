...
var _n_ls = "http://logcol.kyobobook.co.kr/wlo/Logging";		/* logging server */
var _n_uls = "http://logcol.kyobobook.co.kr/wlo/UserLogging";	/* user logging server */
...
if ( document.location.protocol == "https:" ) {
	_n_ls = "https://logcol.kyobobook.co.kr/wlo/Logging";
	_n_uls = "https://logcol.kyobobook.co.kr/wlo/UserLogging";
}
...
function n_getReferrer()
{
    ...
    try{
		...
		if ( queryDict.OV_REFFER )
			return queryDict.OV_REFFER;
